...
get_player_stats_config <- function() {
  data <- tribble(
    ...
    # "PLAYER", "https://www.basketball-reference.com/players/{node1}/{node2}.html", ""table#totals_stats", "tfoot tr:nth-child(1) > *", "", "fg",  "pts_per_g", "", FALSE, TRUE, c("data_stat", "text"), "data-stat", ""
    # "PLAYER", "https://www.basketball-reference.com/players/{node1}/{node2}.html", "table#per_game_stats", "tfoot tr[id] > *", "", "games",  "vorp", "", FALSE, FALSE, c("data_stat", "text"), "data-stat", ""
  )
  data
}